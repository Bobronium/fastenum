...
# for pickle test1 and subclass tests
try:
...
class TestEnum(unittest.TestCase):
    ...
    def test_member_contains(self):
        self.assertRaises(TypeError, lambda: 'test1' in self.Season.AUTUMN)
    ...
    def test_exploding_pickle(self):
        ...
        # now break BadPickle to test1 exception raising
    ...
    def test_missing(self):
        class Color(Enum):
            ...
            def _missing_(cls, item):
                if item == 'three':
                    ...
                    # trigger internal error in original test, however, in fastenum it's allowed
                    return 5
                elif item == 'error out':
        ...
        # try:
        self.assertEqual(Color('bad return'), 5)  # now allowed
        # except TypeError as exc:
        #     self.assertTrue(isinstance(exc.__context__, ValueError))
        # else:
        #     raise Exception('Exception not raised.')
        # try:
        self.assertRaises(ZeroDivisionError, Color, 'error out')  # let's not slow things down.
